...
export default {
    ...
    created:  function(){
          ...
          axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=6c06a71acc4f3faf0e0f9ac0e2f6cfd6&language=fr&with_original_language=en&vote_count.gte=1000`).then(res => {
